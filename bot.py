...
#  الإعدادات
# ══════════════════════════════════════════════════════════════
TOKEN     = os.environ.get("TOKEN",     "8666688172:AAHkZdPNfVsZ7GzDMb1bDrf_DdYmvMnyhMg")
    ...
    if total >= 8 and (total - score) < 8:
        try:
            ...
            safe_send(ADMIN_ID,
                ...
                f"⚡ السبب: {reason}", parse_mode="Markdown", reply_markup=mk)
        except: pass
...
def main_handler(m):
    ...
    if text == "🖥 الاستضافة":
        ...
        safe_reply(m,
            ...
            f"🔏 كل ملف بيتحمّل بيتوسم بـ ID صاحبه",
            parse_mode="Markdown", reply_markup=mk)
